...
/**
 * 将文件上传到本地服务器，非七牛云、阿里oss
 */

public class LocalServerFileUploadActivity extends BaseActivity {
    ...
    private void initViews() {
        FullyGridLayoutManager manager = new FullyGridLayoutManager(LocalServerFileUploadActivity.this, 4, GridLayoutManager.VERTICAL, false);
    ...
    private void initAdapter() {
        mAdapter = new GridImageAdapter(LocalServerFileUploadActivity.this, onAddPicClickListener);
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片
                        PictureConfig.getInstance().externalPicturePreview(LocalServerFileUploadActivity.this, position, selectMedia);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(LocalServerFileUploadActivity.this, selectMedia.get(position).getPath());
                        }
                        break;
                }
    ...
    private void initListener() {
        ...
        sendTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(LocalServerFileUploadActivity.this,"请稍等....",Toast.LENGTH_LONG).show();
            ...
            switch (type) {
                case 0:
                    ...
                    FunctionOptions options = new FunctionOptions.Builder()
                            ...
                            .create();
                    // 先初始化参数配置，在启动相册
                    PictureConfig.getInstance().init(options).openPhoto(LocalServerFileUploadActivity.this, resultCallback);
